    ...
    inner class TextSizeViewHolder(val textView: TextView) : RecyclerView.ViewHolder (textView) {
        init {
            textView.setOnClickListener {
                ...
                Log.d("textSizeViewHolder", "adapterPosition = $adapterPosition")
                Log.d("TextSizeViewHolder", "textSizes[adapterPosition] = ${textSizes[adapterPosition]}")
                }
            }
    }
